                                      ...
                                      FormField(
                                        ...
                                        builder: (state){
                                          return Column(
                                            ...
                                            children: [
                                              TextoTituloForm(texto: 'Foto de Perfil',),
                                              ...
                                              Card(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Stack(
                                                    children: [
                                                      if(login.imagem.path.isNotEmpty)
                                                        Center(
                                                          child: Image.file(
                                                            login.imagem,
                                                            height: 220,
                                                      ...
                                                      Align(
                                                        alignment: login.imagem.path.isNotEmpty?
                                                        Alignment.topRight:
                                                        Alignment.center,
                                                        child: Padding(
                                                          ...
                                                          child: IconButton(
                                                            onPressed: ()async{
                                                              await login.pegarImagemGaleria(context);
                                                            },
                                      ...
                                      FormField(
                                        ...
                                        builder: (state){
                                          return Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              TextoTituloForm(texto: 'Informe seu nome completo',),
                                              const SizedBox(height: 4,),
                                              Container(
                                      ...
                                      FormField(
                                        ...
                                        builder: (state){
                                          return Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              TextoTituloForm(texto: 'Informe seu cpf',),
                                              const SizedBox(height: 4,),
                                              Container(
                                                decoration: BoxDecoration(
                                                  color: Colors.white,
                                      ...
                                      FormField(
                                        ...
                                        builder: (state){
                                          return Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              TextoTituloForm(texto: 'Informe seu grau',),
                                              const SizedBox(height: 4,),
                                              Container(
                                                decoration: BoxDecoration(
                                                  color: Colors.white,
                                            ...
                                            if(compararSenhas(senha: _passController.text,segundaSenha: _twoPassController.text)){
                                              ...
                                              login.postCadastrarUser(
                                                  ...
                                                  onFail: (mensagem){
                                                    ...
                                                    login.retornarMensagemCadastrar(
                                                      voltarTela: false,
                                                      context: context,
